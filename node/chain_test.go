...
import (
	...
	"github.com/novikoff/saturn/types"
	"github.com/novikoff/saturn/util"
...
func TestAddBlockWithTxInsufficientFunds(t *testing.T) {
	...
	prevTx, err := chain.txStore.Get("0433d2e8303b724b9c71cad56d43e85abd1852d6ac2b439e1d2481a63a54873a")
	assert.Nil(t, err)
